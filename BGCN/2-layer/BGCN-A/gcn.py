...
flags.DEFINE_float('alpha', 0.3, 'alpha balancing BGCN')
...
#bilinear matrices
A_2, adj_hop1_all, adj_hop2_all, N_hop1_all, N_hop2_all = preprocess_bilinear(adj)
# Some preprocessing
features= preprocess_features(features)

if FLAGS.model == 'bgcn':
    support = [A_2, adj_hop1_all, adj_hop2_all, N_hop1_all, N_hop2_all]
    num_supports = 5
    model_func = BGCN
