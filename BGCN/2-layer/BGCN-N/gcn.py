...
flags.DEFINE_float('beta', 0.7, 'beta balancing BGCN-target')
...
#bilinear matrices
A_2, adj_hop1_neig, adj_hop2_neig, N_hop1_neig, N_hop2_neig = preprocess_bilinear(adj)
# Some preprocessing
features= preprocess_features(features)

if FLAGS.model == 'bgcn':
    support = [A_2, adj_hop1_neig, adj_hop2_neig, N_hop1_neig, N_hop2_neig]
    num_supports = 5
    model_func = BGCN
