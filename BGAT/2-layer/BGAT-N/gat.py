...
adj_hop1_all, adj_hop2_all, adj_hop1_neig, adj_hop2_neig, N_hop1_neig, N_hop2_neig = process.preprocess_bilinear(adj)
...
N_hop1_neig_in = tf.sparse_placeholder(dtype=tf.float32)
N_hop2_neig_in = tf.sparse_placeholder(dtype=tf.float32)
...
logits = model.inference(ftr_in, nb_classes, nb_nodes, is_train,
                            ...
                            N_hop1_neig_mat=N_hop1_neig_in,
                            N_hop2_neig_mat=N_hop2_neig_in,
...
for epoch in range(FLAGS.epochs):
    ...
    _, loss_value_tr, acc_tr = sess.run([train_op, loss, accuracy],
        feed_dict={
            ...
            N_hop1_neig_in: N_hop1_neig,
            N_hop2_neig_in: N_hop2_neig,
            lbl_in: y_train[0:1],
