...
class SpGAT(BaseGAttN):
    def inference(inputs, nb_classes, nb_nodes, training, attn_drop, ffd_drop,
            bias_mat, adj_hop1_all_mat, adj_hop2_all_mat, adj_hop1_neig_mat,adj_hop2_neig_mat, N_hop1_target_mat,N_hop2_target_mat,
        ...
        for _ in range(n_heads[0]):
            attns.append(layers.sp_attn_head(inputs, adj_mat=bias_mat,
                                             ...
                                             N_hop1_target_mat=N_hop1_target_mat, N_hop2_target_mat=N_hop2_target_mat,
