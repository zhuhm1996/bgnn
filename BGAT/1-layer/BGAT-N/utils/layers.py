...
def sp_attn_head(seq, out_sz, adj_mat, adj_all_mat, adj_neig_mat, N_neig_mat, activation, nb_nodes, in_drop=0.0, coef_drop=0.0, residual=False):
    with tf.name_scope('sp_attn'):
        ...
        adj_neig_mat_bi = tf.SparseTensor(indices=adj_neig_mat.indices,
                                      values=adj_neig_mat.values*adj_neig_mat.values,
                                      dense_shape=adj_neig_mat.dense_shape)
        ...
        out_bi = dot(N_neig_mat, BILinear_pooling(adj_neig_mat, adj_neig_mat_bi, seq_fts), True)
