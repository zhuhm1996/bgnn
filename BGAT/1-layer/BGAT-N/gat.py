...
flags.DEFINE_float('feadrop', 0.4, 'feature Dropout rate (1 - keep probability).')
flags.DEFINE_float('attdrop', 0.4, 'attention Dropout rate (1 - keep probability).')
...
adj_all, adj_neig, N_neig = process.preprocess_bilinear(adj)
...
N_neig_in = tf.sparse_placeholder(dtype=tf.float32)
